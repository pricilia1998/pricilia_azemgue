...
sabrine::sabrine(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::sabrine)
{
    ui->setupUi(this);
...
void sabrine::on_ajouterR_clicked()
{
...
bool sabrine::on_rechermodifR_clicked()
{
...
void sabrine::on_ajouterZ_clicked()
{
...
bool sabrine::on_rechermodifZ_clicked()
{
...
void sabrine::on_modifierR_clicked()
{
        int ID_RECOLTE;
        QString CULTURE;
        float PRIX;
...
void sabrine::on_modifierZ_2_clicked()
{
...
void sabrine::on_radioButton_clicked()
{
    Zone   *sa = nullptr ;
...
void sabrine::on_ASCR_clicked()
{
    Recolte  *sa = nullptr ;
    ui->tableViewrecolte->setModel(sa->tri_recolte());//refresh
}

void sabrine::on_DESC_clicked()
{
    Zone   *sa = nullptr  ;
   ui->tableViewzone->setModel(sa-> tri_zoneDESC());//refresh
}

void sabrine::on_DESCR_clicked()
{
    Recolte  *sa = nullptr ;
    ui->tableViewrecolte->setModel(sa->tri_recolteDESC());//refresh
}

void sabrine::on_lineEditCR_textChanged(const QString &arg1)
{
...
void sabrine::on_IDD_textChanged(const QString &arg1)
{
     ui->IDD->setValidator( new QDoubleValidator(0, 50, 0, this));
}

void sabrine::on_line_textEdited(const QString &arg1)
{
